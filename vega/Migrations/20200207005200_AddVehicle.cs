        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleFeatureFeatureId = table.Column<int>(nullable: true),
                    VehicleFeatureVehicleId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleFeature_VehicleFeature_VehicleFeatureVehicleId_VehicleFeatureFeatureId",
                        columns: x => new { x.VehicleFeatureVehicleId, x.VehicleFeatureFeatureId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleFeature_VehicleFeatureVehicleId_VehicleFeatureFeatureId",
                table: "VehicleFeature",
                columns: new[] { "VehicleFeatureVehicleId", "VehicleFeatureFeatureId" });
